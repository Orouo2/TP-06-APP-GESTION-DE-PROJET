 ...
 */
final class Version20250416120931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE issue ADD status SMALLINT NOT NULL, ADD key_code VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE issue DROP status, DROP key_code');
    }
}
