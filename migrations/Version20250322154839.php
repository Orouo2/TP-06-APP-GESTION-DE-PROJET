...
final class Version20250322154839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, naname VARCHAR(255) NOT NULL, key_code VARCHAR(5) NOT NULL, lead_user_id INT NOT NULL, INDEX IDX_2FB3D0EEFEA08FFB (lead_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
